...
<p>The top of this bar displays the details of the file under analysis. In this example, the file is named "Test.exe". The process ID allocated by the operating system is indicated as "12880". The current module being analyzed is "ntdll.dll", and the main thread is identified as "7944".</p>
...
<ul>
  <li>
    <img src="/assets/img/post-img/18-10-2023/x64dbg-Folder-Icon-Toolbar.png" class="post-images" alt="x64dbg Folder Icon Toolbar"><p>This is used to open a file for analysis.</p>
  </li>
</ul>

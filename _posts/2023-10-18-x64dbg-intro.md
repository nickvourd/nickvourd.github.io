...
<p>The following image displays a row of icons, which is a part of the main toolbar, providing various views and data that can assist in simplifying the analysis.</p>

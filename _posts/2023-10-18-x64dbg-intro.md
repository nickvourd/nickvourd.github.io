...
<ul>
  <li>
    <p>📁: This is used to open a file for analysis.</p>
  </li>
  <li>
    <p>🔄: This is used to restart the analyzed program.</p>
  </li>
  <li>
    <p>⏹️: This is used to stop the running program.</p>
  </li>
  <li>
    <p>➡️: This is used to run the program.</p>
  </li>
  <li>
    <p>⏸️: This is used to pause the running program.</p>
  </li>
</ul>

...
<ul>
  ...
  <li>
    <p>⬇️(Step Into): This is used to execute the next instruction in the program and then pause.</p>
  </li>
  <li>
    <p>⤵️(Step Over): This is used to execute the next instruction without entering any called functions and then pause.</p>
  </li>
</ul>

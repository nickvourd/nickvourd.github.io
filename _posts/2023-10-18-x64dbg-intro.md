...
<p>The top of this bar displays the details of the file under analysis. In this example, the file is named "Test.exe". The process ID allocated by the operating system is indicated as "12880". The current module being analyzed is "ntdll.dll", and the main thread is identified as "7944".<br />

The following image displays the main icons of the toolbar for exploring the assembly code of the analyzed malware</p>

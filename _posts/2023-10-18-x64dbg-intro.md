...
<p>Before we explain what all of these are, we should make a little change to the GUI. If you are someone who respects yourself, please change the display theme to the dark theme. In order to do that, you should go on top bar and choose <b>Options</b> > <b>Theme</b> > <b>Dark</b>.</p>

<img src="/assets/img/post-img/18-10-2023/x64dbg-Dark-Theme.png" class="post-images" alt="Dark Theme x64dbg">

<p>Thanks for this, the dark theme makes life better! 😛</p>

<h3>x64dbg GUI details</h3>
